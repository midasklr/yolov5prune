...
def test_prune(data,
    ...
    thre_index = int(len(sorted_conv) * opt.percent)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/kong/yolov5/runs/train/exp171/weights/last.pt',
