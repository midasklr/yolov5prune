...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        model = ckpt["model"].to(device)  # create
        logger.info("Succeed load pruned model")
        print(model)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/kong/yolov5/runs/train/exp136/weights/last.pt', help='initial weights path')
